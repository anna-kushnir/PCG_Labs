...
public class SpecularLightingMode extends WorkMode {
    ...
    public SpecularLightingMode() {
        ...
        lightCoords = new float[]{ 0.0f, 0.0f, 0.31f };
    }
    ...
    public void createShaderProgram() {
        compileAndAttachShaders(Shaders.vertexShaderCode, Shaders.fragmentShaderCode2);
